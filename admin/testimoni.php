...
if (!$data) {
    die("Query testimoni error: " . mysqli_error($conn));
}
?>
<!DOCTYPE html>
<html lang="id">
...
<div class="admin-layout">
    <div class="sidebar">
        <div>
            ...
            <a href="testimoni.php" class="sidebar-link active">💬 Testimoni</a>
        ...
        <div class="sidebar-card">
            ...
            <div class="fw-semibold mb-3">Atur ulasan yang tampil di website utama.</div>
    ...
    <div class="main-content">
        <div class="topbar-box">
            <h2 class="mb-1">Data Testimoni</h2>
            <p class="text-muted-custom mb-0">Kelola ulasan pengunjung yang tampil di website utama.</p>
        </div>
                        ...
                        <tr>
                            ...
                            <td class="text-end pe-4">
                                <div class="d-inline-flex gap-2">
                                    <a href="../aksi_hapus_testimoni.php?id=<?= $row['id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin hapus testimoni?')">Hapus</a>
                                </div>
                            </td>
                        </tr>
                        <?php endwhile; ?>
