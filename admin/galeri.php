...
if (!$data) {
    die("Query galeri error: " . mysqli_error($conn));
}
?>
<!DOCTYPE html>
<html lang="id">
...
<div class="admin-layout">
    <div class="sidebar">
        <div>
            ...
            <a href="galeri.php" class="sidebar-link active">🖼️ Galeri</a>
        ...
        <div class="sidebar-card">
            ...
            <div class="fw-semibold mb-3">Atur foto galeri yang tampil di halaman utama.</div>
    ...
    <div class="main-content">
        <div class="topbar-box d-flex justify-content-between align-items-center">
            <div>
                <h2 class="mb-1">Data Galeri</h2>
                <p class="text-muted-custom mb-0">Kelola data galeri yang tampil di website utama.</p>
            </div>
                ...
                <table class="table table-bordered align-middle">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><?= $no++; ?></td>
                            <td>
                                <img src="../assets/img/<?= htmlspecialchars($row['gambar'] ?? ''); ?>" width="120" class="img-thumbnail">
                            </td>
                            <td><?= htmlspecialchars($row['gambar'] ?? ''); ?></td>
                            <td class="text-end pe-4">
                                <div class="d-inline-flex gap-2">
                                    <a href="edit_galeri.php?id=<?= $row['id']; ?>" class="btn btn-warning btn-sm">Edit</a>
                                    <a href="../aksi_hapus_galeri.php?id=<?= $row['id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin hapus data?')">Hapus</a>
                                </div>
                            </td>
                        </tr>
                        <?php endwhile; ?>
