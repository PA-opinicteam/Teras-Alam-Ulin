...
if (!$data) {
    die("Query fasilitas error: " . mysqli_error($conn));
}
?>
<!DOCTYPE html>
<html lang="id">
...
<div class="admin-layout">
    <div class="sidebar">
        <div>
            ...
            <a href="fasilitas.php" class="sidebar-link active">🏕 Fasilitas</a>
        ...
        <div class="sidebar-card">
            ...
            <div class="fw-semibold mb-3">Atur fasilitas yang tampil di halaman utama.</div>
    ...
    <div class="main-content">
        <div class="topbar-box d-flex justify-content-between align-items-center">
            <div>
                ...
                <p class="text-muted-custom mb-0">Kelola data fasilitas yang tampil di website utama.</p>
            </div>
            ...
            <div class="table-responsive">
                <table class="table table-bordered align-middle">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><?= $no++; ?></td>
                            <td><?= htmlspecialchars($row['nama_fasilitas'] ?? $row['nama'] ?? ''); ?></td>
                            <td><?= htmlspecialchars($row['icon'] ?? $row['ikon'] ?? ''); ?></td>
                            <td class="text-end pe-4">
                                <div class="d-inline-flex gap-2">
                                    <a href="edit_fasilitas.php?id=<?= $row['id']; ?>" class="btn btn-warning btn-sm">Edit</a>
                                    <a href="../aksi_hapus_fasilitas.php?id=<?= $row['id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin hapus data?')">Hapus</a>
                                </div>
                            </td>
                        </tr>
                        <?php endwhile; ?>
